  ...
  timeline: [
    {
      ...
      description: "A premier month-long project-building hackathon held in the winter break of December 2025.",
    },
    {
      year: 2025,
      event: "CODE-A-THON",
    ...
    },
    {
      ...
      description: "The flagship event of Developers Club with 1100+ participants and 250+ projects developed during a 48-hour innovation sprint.",
    },
    {
      year: 2024,
      event: "RandomWalk.ai Collaboration",
      description: "Developers Club collaborated with RandomWalk.ai on AI-focused projects giving students exposure to real-world machine learning applications.",
    },
  ],
  projects: [
    {
      name: "Web Scraping using Python",
      description: "Introductory session covering data extraction using BeautifulSoup and Requests libraries.",
      image: "/clubs/devclub/events/web_scraping.png",
    },
    {
      name: "Web Automation",
      description: "Session focused on browser automation using Selenium and workflow automation techniques.",
      image: "/clubs/devclub/events/web_automation.png",
    },
    {
      name: "Node.js & Express.js",
      description: "Backend development session covering REST APIs, middleware, and server architecture.",
      image: "/clubs/devclub/events/nodejs.webp",
    },
    {
      name: "Gemini API Session",
      description: "Hands-on workshop exploring AI integration into applications using Gemini API.",
      image: "/clubs/devclub/events/gemini.webp",
    },
    {
      name: "Linux Basics Session",
      description: "Introduction to Ubuntu, command line usage, and development environment setup.",
      image: "/clubs/devclub/events/linux.jpeg",
    },
    {
      name: "Devember Hackathon",
      description: "A competitive hackathon encouraging innovation and real-world solution development.",
